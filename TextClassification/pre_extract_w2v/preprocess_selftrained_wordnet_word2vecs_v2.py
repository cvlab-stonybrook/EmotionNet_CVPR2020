...
def main():
    ...
    default_public_w2v_file = '/home/zwei/Dev/AttributeNet3/AdobeStockSelection/RetrieveSelected778/data_v6_690_xmas/word2vec/word2vec.model'

    directory = "./params"
    fpath_pretrained_extracted = os.path.expanduser("{}/selftrained_extracted_w2v_wordnet_synsets_py{}.pl".format(directory, sys.version_info.major))
