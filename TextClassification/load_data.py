...
predefined_emotions = sorted(['surprise(negative)', 'happiness', 'sadness', 'disgust', 'surprise(positive)', 'neutral', 'anger', 'fear'])
...
def read_AMT_complete_mtrain_stest(data_path=None):
    ...
    # output_data["dev_set"] = updated_val_data
    # output_data["train_set"] = updated_train_data
...
if __name__ == '__main__':
    ...
    train_set, val_set = read_AMT_complete_mtrain_stest()
    tag_lengths = {}
