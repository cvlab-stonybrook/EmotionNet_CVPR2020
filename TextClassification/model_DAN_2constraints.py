...
class CNN(nn.Module):
    ...
    def forward(self, inp):
        ...
        return x_final, raw_feature, x_feat.permute(0, 2, 1)
...
class CNN_Embed_v2_withFeature(nn.Module):
    def __init__(self, **kwargs):
        super(CNN_Embed_v2_withFeature, self).__init__()
    ...
    def forward(self, inp):
        ...
        # x_avg_drop = F.dropout(x_avg_bn, p=self.DROPOUT_PROB, training=self.training)
        x_fc1 = self.fc1(x_avg_bn)
        return x_fc1, x_feat.permute(0, 2, 1)
