...
project_root = os.path.join(os.path.expanduser('~'), 'Dev/AttributeNet2')
...
if __name__ == '__main__':
    ...
    for s_status in tqdm.tqdm(pool.imap_unordered(resize_wrapper, operating_files), total=len(operating_files),
                              desc="Copying"):
