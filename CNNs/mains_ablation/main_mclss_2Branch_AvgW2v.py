...
from TextClassification.model_DAN import CNN_Embed_v2 as Text_Embed
...
def main():
    ...
    #     text_word2vec = loadpickle(args.word2vec)
    #     idx2tag = torch.load(args.text_ckpt)['idx2tag']
    #     args.vocab_size = len(idx2tag)
    #     text_model = {"w2v": text_word2vec, "idx2tag": idx2tag}
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # train for one epoch
        train(train_loader, visual_model, criterion, optimizer, epoch, args, print_func)
