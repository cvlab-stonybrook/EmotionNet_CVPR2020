...
# Author: Zijun Wei
# Usage(TODO): ablation study 1: directly fine-tune on the 30K images
# Email: hzwzijun@gmail.com
# Created: 12/Mar/2019 16:28
...
def main():
    ...
    # Data loading code
    val_dataset = get_instance(custom_datasets, '{0}_val'.format(args.dataloader), args)
    ...
    if args.evaluate:
        ...
        train_dataset = get_instance(custom_datasets, '{0}_train'.format(args.dataloader), args)
