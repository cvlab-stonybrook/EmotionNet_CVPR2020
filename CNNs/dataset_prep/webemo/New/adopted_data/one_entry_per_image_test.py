...
train_CIDs = loadpickle('/home/zwei/Dev/AttributeNet/CNNs/dataset_prep/webemo/New/adopted_data/train-CIDs-fullinfo-non-repeat.pkl')

CIDs = set()
new_data = {}
for s_data in data:
    if s_data[0] in train_CIDs:
        #print("{} in Test Set".format(s_data[0]))
        continue
    if s_data[0] in CIDs:
