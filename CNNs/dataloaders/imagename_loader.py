...
class ImageNamesRelLists(DatasetList):
    ...
    def __init__(self, image_paths, image_root, transform=None, target_transform=None,
        ...
        super(ImageNamesRelLists, self).__init__(samples, loader,
                                                 transform=transform,
                                                 target_transform=target_transform)
        self.imgs = self.samples


class ImageNamesReDicts(DatasetList):
    def __init__(self, image_ids, annotation_dicts, image_root, transform=None, target_transform=None,
        ...
        super(ImageNamesReDicts, self).__init__(samples, loader,
                                                transform=transform,
                                                target_transform=target_transform)
        self.imgs = self.samples
