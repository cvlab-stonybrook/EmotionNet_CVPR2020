...
from TextClassificationV2.models.TextCNN import TextCNN_Z as TextCNN
...
def main():
    ...
    save_checkpoint(save_items, is_best=False, filename='../ckpts/{}_Z.pth.tar'.format(args_hyper.w2v_type))
