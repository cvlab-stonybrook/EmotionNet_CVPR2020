...
from TextClassificationV2.models.TextCNN import TextCNN_Avg as TextCNN
...
def main():
    ...
    save_checkpoint(save_items, is_best=False, filename='../ckpts/{}.pth.tar'.format(args_hyper.w2v_type))
