...
from TextClassificationV2.data_loader.Emotion690 import read_690_complete_mtrain_mtest, convert_list2multihot
...
def main():
    ...
    train_set, val_set = read_690_complete_mtrain_mtest(subset_N=None)
    ...
    save_checkpoint(save_items, is_best=False, filename='../ckpts/TextCNN_{}_690_NLTDAN_1M_Static.pth.tar'.format(args_hyper.w2v_type))
