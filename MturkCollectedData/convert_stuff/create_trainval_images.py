...
for s_image_cid in tqdm.tqdm(mturk_data, total=len(mturk_data)):
    ...
    if single_label is not None:
        data_list.append([s_rel_path, single_label])
...
save2pickle('/home/zwei/Dev/AttributeNet3/MturkCollectedData/data/train_sclss.pkl', train_split)

save2pickle('/home/zwei/Dev/AttributeNet3/MturkCollectedData/data/test_sclss.pkl', val_split)
