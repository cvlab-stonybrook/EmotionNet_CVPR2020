...
if __name__ == '__main__':
    ...
    import argparse
    import glob
    input_file = '/home/zwei/datasets/stockimage_nrc/download_list.pkl'
    ...
    parser.add_argument('--output_directory', '-t', default='/home/zwei/datasets/stockimage_nrc/images', type=str, help='output filename')
