...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_directory', default='selected_keywords_retrieve', type=str, help='output filename')
    parser.add_argument('--tag_field', default='oksr', choices=['oksr', 'eksr'], type=str)
    parser.add_argument('--keyword_list_file', required=True, help="Spcify a list of keywords to retrieve")
