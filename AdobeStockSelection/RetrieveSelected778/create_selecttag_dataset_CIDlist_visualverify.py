...
# Author: Zijun Wei
# Usage(TODO): create hundreds of images for visually verfiication
...
save2pickle('data_v2/dataset_CIDs_742_visualverification.pkl', list(collected_CIDs))
