...
datasplit = 'train'
image_cid_list = loadpickle('/home/zwei/Dev/AttributeNet3/AdobeStockSelection/RetrieveSelected778/data_v6_691/CNNsplit_key_labels_train.pkl')
...
save2pickle('train_cid_full_tags.pkl', {'cid_tags': processed_images, 'tags_count': tag_counts})
print("DB")
