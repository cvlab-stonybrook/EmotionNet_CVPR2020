...
cid_list = loadpickle('/home/zwei/Dev/AttributeNet3/AdobeStockSelection/RetrieveSelected778/data_v2/dataset_CIDs_742_visualverification.pkl')
...
searchkeys = loadpickle('/home/zwei/Dev/AttributeNet3/AdobeStockSelection/RetrieveSelected778/data_v2/tag-idx-conversion.pkl')['key2idx']
...
for s_raw_annotation_file in tqdm.tqdm(raw_annotation_files, desc="Iterating Through CID Files", total=len(raw_annotation_files)):
    ...
    for s_raw_annotation in s_raw_annotations:
        ...
        if s_cid in processed_cids:
            ...
            image_information.append([s_cid, s_image_relpath, s_image_searchkey, s_valid_tags, s_image_url])

save2pickle('/home/zwei/Dev/AttributeNet3/AdobeStockSelection/RetrieveSelected778/data_v2/visualverification_information.pkl', image_information)
